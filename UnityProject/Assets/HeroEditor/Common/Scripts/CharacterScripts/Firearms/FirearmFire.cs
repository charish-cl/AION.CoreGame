...
namespace Assets.HeroEditor.Common.Scripts.CharacterScripts.Firearms
{
    ...
    public class FirearmFire : MonoBehaviour
    {
        ...
        public IEnumerator Fire()
        {
            ...
            {
                Character.FirearmsRenderers.Single(i => i.name == "Rifle").sprite = Character.Firearms.Single(i => i.name == "RifleEmpty");
            }
        }

        private void FireMuzzlePlay()
        {
            if (Firearm.Params.Type == FirearmType.Crossbow) return;
