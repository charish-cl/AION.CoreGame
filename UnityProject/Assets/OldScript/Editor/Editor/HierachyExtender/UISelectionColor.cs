    ...
    public class UISelectionColor
    {
        ...
        private static void OnHierarchyWindowItemOnGUI(int instanceID, Rect selectionRect)
        {
            ...
            if (bindTool.HashComponent(selectObj) || Selection.instanceIDs.Contains(instanceID))
            {
                ...
                {
                    GUILayout.BeginArea(new Rect(selectionRect.x + 220, selectionRect.y, 100, selectionRect.height));
                    ...
                    {
                        GUILayout.BeginArea(new Rect(selectionRect.x + 320, selectionRect.y, 40, selectionRect.height));
